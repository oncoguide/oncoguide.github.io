---
title: "Preserving your tumor tissue: a guide for patients and families"
date: 2026-06-22
draft: false
description: "How to preserve your tumor tissue for future molecular testing, drug-response work, and personalized therapies. What to ask before a biopsy or surgery."
tags: ["tissue preservation", "biopsy", "fresh frozen tissue", "molecular testing", "biobank"]
...
This is an OncoGuide reproduction of **"Preserving Your Tumor Tissue"**, published by [Future of Cancer Care Today (FCCT)](https://sijbrandijfoundation.org/FCCT), an initiative of the Sijbrandij Foundation. We republish it with attribution so patients in every language can use it. The medical content is unchanged. Read the [original English PDF](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf).
{{< /callout >}}
...
- Storage policies vary, though institutions commonly retain blocks under [College of American Pathologists (CAP)](https://www.cap.org/) and other regulatory standards.
...
{{< callout type="important" >}}
**Time-sensitive.** Fresh tissue preservation, additional collection, and third-party storage arrangements all need to be set up before the procedure. If a biopsy or surgery is coming up, now is the time to ask.
{{< /callout >}}
...
1. What happens to my tissue after this procedure?
2. Can additional tissue be collected beyond what is needed for diagnosis?
3. Can a portion be preserved fresh or frozen, not only fixed in chemicals?
4. How much tissue is likely to remain after diagnosis, and how long will it be stored?
5. If I want to use a tissue preservation service, can the team coordinate with them?
6. Given my diagnosis, what tests might this tissue be useful for, now or later?
...
{{< callout type="tip" >}}
Different cancers need different tests. For what matters most in your specific situation, see our [master guides by molecular subtype](/en/cancer-types/).
{{< /callout >}}

---

{{< action-box >}}
1. **If a biopsy or surgery is scheduled, raise tissue preservation now** -- before the procedure, not after.
2. **Ask whether extra tissue can be collected** beyond what diagnosis needs, and whether a portion can be kept fresh or frozen.
3. **Ask where your tissue will be stored** and for how long.
4. **If a procedure already happened, ask what tissue still exists** and whether it can be used or transferred to another lab.
5. **Read the [original FCCT guide](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf)** and bring the questions above to your care team.
{{< /action-box >}}
