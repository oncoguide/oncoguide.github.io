---
title: "My story: from back pain to a complete cancer diagnosis in ten days"
date: 2026-06-22
draft: false
description: "The real story of a 42-year-old non-smoker diagnosed with RET-positive lung cancer at stage IV. How I went from back pain to a full diagnosis and treatment in ten days."
tags: ["lung cancer", "RET", "diagnosis", "patient story", "stage IV", "biopsy", "molecular testing"]
categories: ["Blog"]
...
{{< action-box >}}
1. Ask, as early as possible, for complete molecular testing (NGS). For many types of cancer, the mutation that's found completely changes the treatment.
2. Ask about a PET-CT before the biopsy, so the sample is taken from a place that's definitely active.
3. Ask whether frozen ("fresh-frozen") tissue from the biopsy can be preserved -- it may open the door to future treatments.
4. Ask for a second opinion, ideally at a center specialized only in oncology, with a tumor board.
5. Check your reimbursement rights and don't accept a bureaucratic refusal as the final answer.
{{< /action-box >}}
