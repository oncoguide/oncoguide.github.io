---
title: "Cancer du poumon avec fusion RET : le guide complet pour les patients"
date: 2026-03-19
draft: false
description: "Tout savoir sur le cancer du poumon RET fusion-positif : traitement par Selpercatinib, effets secondaires, urgences, resistance, acces en France et en Europe."
tags: ["cancer du poumon", "fusion RET", "selpercatinib", "Retevmo", "therapie ciblee", "guide patient"]
...
**Si vous n'avez eu que la FISH, sans NGS :** Demandez une confirmation par NGS. La FISH peut donner des resultats faux-positifs et n'identifie pas le partenaire exact de fusion. Le NGS detecte aussi les co-mutations qui influencent le pronostic.
{{< /callout >}}
...
**Votre cancer N'EST PAS cause par le tabac.** C'est un accident genetique spontane dans les cellules tumorales, pas dans vos genes hereditaires. Si vous etes au debut de votre parcours, lisez aussi le [guide complet du diagnostic oncologique](/fr/diagnosis/guide-complet-diagnostic/) -- vous y trouverez l'ordre correct des etapes, du PET-CT aux tests moleculaires.
...
**N'ACCEPTEZ PAS l'immunotherapie seule pour un cancer du poumon RET-fusionne.** Le standard international de traitement est le Selpercatinib, pas le pembrolizumab ou le nivolumab.
{{< /callout >}}
...
{{< callout type="tip" >}}
**Verifiez tout aliment ou supplement avant de le consommer.** Vous pouvez utiliser un outil d'IA (comme ChatGPT, Claude ou Gemini) pour verifier rapidement l'interaction entre le Selpercatinib et tout ingredient. Demandez : 'Le [nom de l'aliment] interagit-il avec le Selpercatinib (inhibiteur RET, substrat CYP3A4/CYP2C8) ?' Cela ne remplace pas l'avis medical, mais peut vous aider a identifier des risques a discuter avec votre equipe d'oncologie.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Dyspnee nouvelle ou aggravee + toux seche + fievre** -- Appelez le 15 (SAMU) / Allez aux urgences IMMEDIATEMENT. Cette triade est le signal d'alarme de la pneumopathie medicamenteuse. **NE prenez PAS la prochaine dose** tant qu'un medecin ne vous a pas evalue.
{{< /callout >}}

{{< callout type="warning" >}}
**Vous crachez du sang OU saignement inexplique qui ne s'arrete pas** -- Appelez le 15 IMMEDIATEMENT. Les evenements hemorragiques sont documentes avec le Selpercatinib, y compris les hemorragies cerebrales et respiratoires.
{{< /callout >}}

{{< callout type="warning" >}}
**Jaunissement de la peau/des yeux + urines foncees + douleur abdominale superieure droite** -- Allez aux urgences LE JOUR MEME. Signes classiques d'hepatotoxicite severe. **Arretez le Selpercatinib et allez directement aux urgences.**
{{< /callout >}}

{{< callout type="warning" >}}
**Douleur thoracique + palpitations + syncope ou pre-syncope** -- Appelez le 15 IMMEDIATEMENT. Le Selpercatinib cause une prolongation du QTc -- un changement dangereux du rythme cardiaque. Dites aux urgences que vous etes sous Selpercatinib -- ils feront un ECG immediatement.
{{< /callout >}}

{{< callout type="warning" >}}
**Faiblesse soudaine d'un cote du corps + cephalee severe + confusion** -- Appelez le 15 IMMEDIATEMENT. Signes d'hemorragie cerebrale ou d'AVC.
{{< /callout >}}

{{< callout type="warning" >}}
**Pression thoracique + difficulte a respirer en position allongee** -- Allez aux urgences LE JOUR MEME. Suspicion d'epanchement pericardique (liquide autour du coeur).
{{< /callout >}}

{{< callout type="warning" >}}
**Fatigue severe + crampes musculaires + urines foncees + nausees (surtout les premieres semaines)** -- Allez aux urgences / Appelez la ligne d'astreinte d'oncologie IMMEDIATEMENT. Suspicion de syndrome de lyse tumorale.
{{< /callout >}}

{{< callout type="warning" >}}
**Fievre superieure a 38,5C + frissons + frequence cardiaque rapide + sans cause evidente** -- Appelez la ligne d'astreinte d'oncologie IMMEDIATEMENT. Si pas de reponse dans les 15 minutes -- allez aux urgences. **La fievre chez un patient oncologique sous therapie ciblee est une urgence medicale jusqu'a preuve du contraire.**
{{< /callout >}}
...
1. **Biopsie liquide (ctDNA)** -- test sanguin qui detecte les mutations de resistance **des mois avant** que les scanners ne montrent une croissance tumorale
2. **Re-biopsie tissulaire** -- si la biopsie liquide est negative mais la progression est claire
3. **NGS complet** -- obligatoire a chaque re-biopsie
...
**Contexte :** Le Selpercatinib a ete approuve initialement comme traitement de **deuxieme ligne** (apres echec de la chimiotherapie). En 2022 (FDA) et 2023 (EMA), il a ete actualise en **traitement de premiere ligne** sur la base des resultats de LIBRETTO-431. Tant [l'ESMO](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer) que le [NCCN](https://www.nccn.org/professionals/physician_gls/pdf/nscl.pdf) recommandent desormais le Selpercatinib comme **monotherapie de premiere ligne Categorie 1**.
...
1. **Contactez un avocat** specialise en droit medical
2. L'avocat depose une **"Ordonanta Presedintiala"** (ordonnance de reference d'urgence) contre la CNAS
3. Le dossier judiciaire doit inclure une lettre de l'oncologue, les referentiels cliniques ESMO, et l'AMM de l'EMA pour Retevmo
4. **Delai :** Le tribunal accorde generalement l'ordonnance en **3-4 semaines**
5. Une fois approuve, la CNAS couvre le cout integral -- **le traitement est gratuit pour le patient**

{{< callout type="important" >}}
**N'attendez pas que la CNAS ajoute le Selpercatinib a la liste standard de remboursement** -- cela peut prendre des annees. La voie de l'Ordonanta Presedintiala est le parcours etabli que les patients roumains utilisent pour les medicaments de maladies rares non encore inscrits sur la liste.
{{< /callout >}}
...
|---|---|
| **[RETpositive.org](https://www.retpositive.org)** | Groupes Facebook prives, suivi des essais cliniques, registres de qualite de vie, temoignages de patients |
| **[The Happy Lungs Project](https://www.happylungsproject.org)** | Actualites de recherche specifiques RET, temoignages, webinaires |
| **[RET Renegades](https://www.facebook.com/groups/retrengades)** (Facebook) | Groupe de soutien co-fonde par une survivante RET+ CBNPC de 18+ ans |
| **[LUNGevity Foundation](https://www.lungevity.org)** | Communautes de soutien specifiques RET, navigateur LungMATCH |
| **[Cancer GRACE](https://cancergrace.org)** | Forum pour patients RET-fusion, discussions sur les traitements |
| **[Inspire](https://www.inspire.com)** | Forums de soutien entre patients pour le cancer du poumon et les maladies rares |
| **[HealthUnlocked](https://healthunlocked.com)** | Communaute en ligne pour patients atteints de cancer du poumon |
...
- **[LUNGevity pour les aidants](https://www.lungevity.org/for-supporters-caregivers)** -- forums en ligne pour les familles
- **[CancerCare](https://www.cancercare.org/support_groups)** -- groupe de soutien gratuit de 15 semaines pour les aidants
- **[My Cancer Circle](https://www.mycancercircle.net)** -- outil en ligne gratuit pour organiser le reseau de soins
- **ALA Survivor Network** -- reseau de soutien de l'American Lung Association pour les patients et leurs proches

---

{{< action-box >}}
1. **Imprimez la section "Quand aller aux urgences"** et collez-la sur le refrigerateur et dans votre portefeuille
2. **Imprimez la liste des interactions medicamenteuses** et montrez-la a chaque medecin et pharmacien
3. **Demandez a votre oncologue** quel est votre partenaire de fusion RET, vos co-mutations, et le calendrier d'IRM cerebrale -- voir aussi le [guide du diagnostic](/fr/diagnosis/guide-complet-diagnostic/) pour l'ordre correct des investigations
4. **En France :** Votre traitement est pris en charge a 100% dans le cadre de l'ALD -- confirmez avec votre oncologue. **En Roumanie :** Contactez un avocat pour l'Ordonanta Presedintiala si vous avez besoin de l'acces en premiere ligne
