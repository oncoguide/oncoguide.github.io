...
**N'acceptez PAS de biopsie sans TEP-TDM.** Vous devez connaitre l'extension de la maladie avant de decider ou et comment la biopsie sera realisee. Dans un centre specialise, le TEP-TDM est la premiere etape. Si votre medecin propose une biopsie sans imagerie complete, demandez pourquoi.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Insistez pour obtenir suffisamment de tissu.** Dites au medecin qui realise la biopsie que vous aurez besoin de tests moleculaires/genetiques (NGS). Si trop peu de materiel est preleve, vous pourriez devoir refaire la biopsie -- ce qui signifie du temps perdu et une procedure supplementaire.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Ne commencez PAS le traitement sans les resultats des tests moleculaires.** Un traitement choisi sans ces informations peut etre inefficace ou meme contre-productif. L'exception : les situations d'urgence medicale ou le retard du traitement met la vie en danger.
{{< /callout >}}
...
{{< callout type="tip" >}}
Preparez un dossier complet avant de demander un deuxieme avis : imagerie sur CD/DVD ou lien, rapport anatomopathologique, resultats des tests moleculaires, toutes les analyses de sang. Plus le dossier est complet, plus l'avis sera pertinent.
{{< /callout >}}
...
{{< callout type="tip" >}}
Ceci n'est pas une publicite pour un centre en particulier. C'est un exemple de la facon dont tout centre oncologique serieux devrait fonctionner. Utilisez ces reperes comme standard lorsque vous evaluez ou vous faire soigner.
{{< /callout >}}
...
1. **N'acceptez PAS de biopsie sans TEP-TDM** -- vous devez connaitre l'extension de la maladie d'abord
2. **Ne commencez PAS le traitement sans tests moleculaires** -- vous pourriez passer a cote du traitement qui vous convient le mieux
3. **N'acceptez PAS un plan d'un seul medecin** -- demandez une RCP
4. **Ne vous contentez PAS de delais de 21 jours ou plus pour les tests** -- il existe des options plus rapides
5. **Ne prenez PAS de decisions majeures dans les 48 premieres heures** -- les emotions sont au maximum, les informations au minimum
6. **Ne cherchez PAS sur Google au hasard** -- l'information non verifiee augmente la panique sans benefice reel
7. **Ne supposez PAS que votre medecin fait tout automatiquement** -- soyez votre propre "patient advocate", posez des questions, verifiez, demandez
...
{{< action-box >}}
1. **Demandez un TEP-TDM corps entier** comme premiere etape, avant la biopsie
2. **Dites au medecin qui realise la biopsie** que vous avez besoin de suffisamment de materiel pour les tests moleculaires NGS
3. **Posez explicitement la question des tests moleculaires** -- quels tests sont realises, quand les resultats arrivent-ils, existe-t-il un panel rapide ?
4. **Demandez la presentation en RCP** -- demandez quand elle aura lieu et ce qui a ete decide
5. **Preparez le dossier pour un deuxieme avis** -- imagerie, anatomopathologie, tests moleculaires, analyses
{{< /action-box >}}
