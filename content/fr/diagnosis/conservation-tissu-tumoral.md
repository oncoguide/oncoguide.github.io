---
title: "Conserver votre tissu tumoral : un guide pour les patients et les familles"
date: 2026-06-22
draft: false
description: "Comment conserver votre tissu tumoral pour de futurs tests moleculaires et therapies personnalisees. Que demander avant une biopsie ou une chirurgie."
tags: ["conservation tissu tumoral", "biopsie", "tissu frais congele", "profilage moleculaire", "biobanque"]
...
Ceci est une reproduction par OncoGuide de **"Preserving Your Tumor Tissue"** (Conserver votre tissu tumoral), publie par [Future of Cancer Care Today (FCCT)](https://sijbrandijfoundation.org/FCCT), une initiative de la Sijbrandij Foundation. Nous le republions avec attribution afin que les patients de toutes les langues puissent l'utiliser. Le contenu medical est inchange. Lisez le [PDF original en anglais](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf).
{{< /callout >}}
...
- Les politiques de conservation varient, meme si les etablissements conservent couramment les blocs selon les normes du [College of American Pathologists (CAP)](https://www.cap.org/) et d'autres normes reglementaires.
...
{{< callout type="important" >}}
**Sensible au temps.** La conservation de tissu frais, le prelevement supplementaire et les arrangements de stockage avec un tiers doivent tous etre mis en place avant l'intervention. Si une biopsie ou une chirurgie approche, c'est le moment de poser la question.
{{< /callout >}}
...
1. Qu'advient-il de mon tissu apres cette intervention ?
2. Peut-on prelever du tissu supplementaire au-dela de ce qui est necessaire au diagnostic ?
3. Une partie peut-elle etre conservee fraiche ou congelee, et non seulement fixee dans des produits chimiques ?
4. Quelle quantite de tissu restera probablement apres le diagnostic, et combien de temps sera-t-elle stockee ?
5. Si je veux faire appel a un service de conservation de tissu, l'equipe peut-elle se coordonner avec lui ?
6. Compte tenu de mon diagnostic, a quels tests ce tissu pourrait-il etre utile, maintenant ou plus tard ?
...
{{< callout type="tip" >}}
Des cancers differents necessitent des tests differents. Pour savoir ce qui compte le plus dans votre situation specifique, consultez nos [guides de reference par sous-type moleculaire](/fr/cancer-types/).
{{< /callout >}}

---

{{< action-box >}}
1. **Si une biopsie ou une chirurgie est programmee, abordez la conservation du tissu des maintenant** -- avant l'intervention, pas apres.
2. **Demandez s'il est possible de prelever du tissu supplementaire** au-dela de ce que le diagnostic exige, et si une partie peut etre conservee fraiche ou congelee.
3. **Demandez ou votre tissu sera stocke** et pour combien de temps.
4. **Si une intervention a deja eu lieu, demandez quel tissu existe encore** et s'il peut etre utilise ou transfere vers un autre laboratoire.
5. **Lisez le [guide FCCT original](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf)** et apportez les questions ci-dessus a votre equipe soignante.
{{< /action-box >}}
