...
{{< action-box >}}
1. **Cere PET-CT whole-body** ca prim pas, înainte de biopsie
2. **Spune medicului care face biopsia** că ai nevoie de suficient material pentru teste moleculare NGS
3. **Întreabă explicit despre testele moleculare** --ce se testează, când vin rezultatele, există panel rapid?
4. **Cere prezentare în comisia oncologică** --întreabă când va fi și ce s-a decis
5. **Pregătește dosarul pentru second opinion** --imagistică, patologie, teste moleculare, analize
{{< /action-box >}}
