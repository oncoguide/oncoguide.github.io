---
title: "Cancer pulmonar cu fuziune RET: ghidul complet pentru pacienti"
date: 2026-03-19
draft: false
description: "Tot ce trebuie sa stii despre cancerul pulmonar RET fusion-pozitiv: tratament cu Selpercatinib, efecte secundare, urgente, rezistenta, acces in Romania."
tags: ["cancer pulmonar", "RET fusion", "selpercatinib", "Retevmo", "terapie tintita", "ghid pacient"]
...
**Daca ai avut doar FISH, fara NGS:** Cere confirmare prin NGS. FISH poate avea rezultate fals-pozitive si nu identifica partenerul exact de fuziune. NGS detecteaza si co-mutatii care influenteaza prognosticul.
{{< /callout >}}
...
**NU accepta imunoterapie singura pentru cancer pulmonar RET-fuzionat.** Standardul international de tratament este Selpercatinib, nu pembrolizumab sau nivolumab.
{{< /callout >}}
...
{{< callout type="tip" >}}
**Verifica orice aliment sau supliment inainte de a-l consuma.** Poti folosi un instrument AI (cum ar fi ChatGPT, Claude sau Gemini) pentru a verifica rapid interactiunea dintre Selpercatinib si orice ingredient sau aliment. Intreaba: "Are [numele alimentului/suplimentului] interactiune cu Selpercatinib (inhibitor RET, substrat CYP3A4/CYP2C8)?" Aceasta nu inlocuieste sfatul medicului, dar te poate ajuta sa identifici riscuri potentiale pe care sa le discuti cu echipa ta de oncologie.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Dispnee noua sau agravata + tuse uscata + febra** -- Suna 112 / Mergi la urgente IMEDIAT. Aceasta triada este semnul de alarma pentru pneumonita medicamentoasa. **NU lua urmatoarea doza** pana cand un medic te evalueaza.
{{< /callout >}}

{{< callout type="warning" >}}
**Tusi sange SAU sangerare inexplicabila care nu se opreste** -- Suna 112 IMEDIAT. Evenimentele hemoragice sunt documentate cu Selpercatinib, inclusiv sangerari cerebrale si respiratorii.
{{< /callout >}}

{{< callout type="warning" >}}
**Ingalbenirea pielii/ochilor + urina inchisa + durere abdominala dreapta sus** -- Mergi la urgente IN ACEEASI ZI. Semne clasice de hepatotoxicitate severa. **Opreste Selpercatinib si mergi direct la urgente.**
{{< /callout >}}

{{< callout type="warning" >}}
**Durere toracica + palpitatii + lesin sau aproape-lesin** -- Suna 112 IMEDIAT. Selpercatinib cauzeaza prelungire QTc -- o schimbare periculoasa a ritmului cardiac. Spune la urgente ca esti pe Selpercatinib -- vor face ECG imediat.
{{< /callout >}}

{{< callout type="warning" >}}
**Slabiciune brusca pe o parte a corpului + durere de cap severa + confuzie** -- Suna 112 IMEDIAT. Semne de hemoragie cerebrala sau AVC.
{{< /callout >}}

{{< callout type="warning" >}}
**Presiune toracica + dificultate de respiratie in pozitie culcata** -- Mergi la urgente IN ACEEASI ZI. Suspecteaza revărsat pericardic (lichid in jurul inimii).
{{< /callout >}}

{{< callout type="warning" >}}
**Oboseala severa + crampe musculare + urina inchisa + greata (mai ales primele saptamani)** -- Mergi la urgente / Suna linia de garda de oncologie IMEDIAT. Suspecteaza sindrom de liza tumorala.
{{< /callout >}}

{{< callout type="warning" >}}
**Febra peste 38,5C + frisoane + ritm cardiac rapid + fara cauza evidenta** -- Suna linia de garda de oncologie IMEDIAT. Daca fara raspuns in 15 minute -- mergi la urgente. **Febra la un pacient oncologic pe terapie tintita este o urgenta medicala pana la proba contrarie.**
{{< /callout >}}
...
1. **Biopsia lichida (ctDNA)** -- test de sange care detecteaza mutatii de rezistenta **cu luni inainte** ca scanarile sa arate crestere tumorala
2. **Re-biopsia tisulara** -- daca biopsia lichida este negativa dar progresia este clara
3. **NGS complet** -- obligatoriu cu fiecare re-biopsia
...
**Context:** Selpercatinib a fost aprobat initial ca tratament de **linia a doua** (dupa esecul chimioterapiei). In 2022 (FDA) si 2023 (EMA), a fost actualizat la **tratament de prima linie** pe baza rezultatelor LIBRETTO-431. Atat [ESMO](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer) cat si [NCCN](https://www.nccn.org/professionals/physician_gls/pdf/nscl.pdf) recomanda acum Selpercatinib ca **monoterapie de prima linie Categorie 1**.
...
1. **Contacteaza un avocat** cu experienta in drept medical (o organizatie de advocacy a pacientilor poate recomanda unul)
2. Avocatul depune o **"Ordonanta Presedintiala"** (ordin de urgenta al instantei) impotriva CNAS
3. Dosarul instantei trebuie sa includa:
   - O scrisoare de la oncologul tau specificand **Selpercatinib (Retevmo)** ca tratament de prima linie recomandat
   - [Ghidurile clinice ESMO pentru NSCLC metastatic](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer)
   - [Autorizatia de comercializare EMA pentru Retevmo](https://www.ema.europa.eu/en/medicines/human/EPAR/retsevmo)
4. **Termen:** Instanta acorda de obicei ordinul in **3-4 saptamani**
5. Odata aprobat, CNAS acopera costul integral -- **tratamentul este gratuit pentru pacient**

{{< callout type="important" >}}
**NU astepta ca CNAS sa adauge Selpercatinib pe lista standard de rambursare** -- poate dura ani. Calea Ordonantei Presedintiale este traseul stabilit pe care pacientii romani il folosesc pentru medicamente de boli rare care nu sunt inca pe lista.
{{< /callout >}}
...
1. **Alege o farmacie** de unde vei ridica medicamentul de acum inainte
2. Oncologul trebuie sa-ti scrie **retete simple** (ca cele de antibiotice) -- **NU retete electronice cu cod QR**. Retetele cu QR merg prin sistemul standard CNAS care nu acopera Selpercatinib prima linie. Reteta simpla, sustinuta de ordinul instantei, ocoleste aceasta limitare
3. **Contacteaza farmacia cu cel putin 1 saptamana inainte** de a ridica medicamentul -- Selpercatinib nu este stocat de rutina si farmacia are nevoie de timp sa-l comande
4. **Pastreaza copii ale ordinului instantei** cu tine tot timpul. Farmacia va trebui sa-l vada
...
| Resursa | Ce ofera |
|---|---|
| [**RETpositive.org**](https://www.retpositive.org) | Grupuri Facebook private, urmarire studii clinice, registre de calitate a vietii |
| [**The Happy Lungs Project**](https://www.happylungsproject.org) | Actualizari de cercetare specifice RET, webinarii, scrisori de la pacienti |
| [**RET Renegades**](https://www.facebook.com/groups/retrengades) (Facebook) | Grup de suport co-fondat de o supravietuitoare RET+ NSCLC de 18+ ani |
| [**LUNGevity Foundation**](https://www.lungevity.org) | Comunitati de suport specifice RET, navigatorul LungMATCH |
| [**Cancer GRACE**](https://cancergrace.org) | Forum pentru pacienti RET-fuziune, discutii de tratament |
| [**Inspire**](https://www.inspire.com/groups/lung-cancer-survivors/) (American Lung Association) | Forumuri dedicate cu discutii despre mutatii RET |
| [**HealthUnlocked**](https://healthunlocked.com/go2-lung-cancer) (GO2 for Lung Cancer) | Discutii despre experienta tratamentului RET-fusion |
...
- [**LUNGevity Caregiver Support Groups**](https://www.lungevity.org/for-supporters-caregivers) -- forumuri online pentru familii de pacienti cu cancer pulmonar
- [**CancerCare 15-Week Online Support Group**](https://www.cancercare.org/support_groups) -- grup gratuit de suport pentru ingrijitori (cancere avansate incluse)
- [**My Cancer Circle**](https://www.mycancercircle.net) -- instrument online gratuit pentru organizarea retelei de ingrijire (programari, mese, suport)
- [**American Lung Association Survivor Network**](https://www.inspire.com/groups/lung-cancer-survivors/) -- sectiuni specifice pentru ingrijitori

---

{{< action-box >}}
1. **Printeaza sectiunea "Cand mergi la urgente"** si pune-o pe frigider si in portofel
2. **Printeaza lista de interactiuni medicamentoase** si arat-o fiecarui medic si farmacist
3. **Intreaba oncologul** despre partenerul de fuziune RET, co-mutatii, si programul de RMN cerebral -- vezi si [ghidul de diagnostic](/ro/diagnosis/ghid-complet-diagnostic/) pentru ordinea corecta a investigatiilor
4. **In Romania:** Contacteaza un avocat pentru Ordonanta Presedintiala daca ai nevoie de acces prima linie la Selpercatinib
