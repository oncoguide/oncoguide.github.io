...
Vestea bună: punerea în comun există deja, parțial. Registre academice internaționale -- de exemplu [Global RET Registry (GLORY)](https://pubmed.ncbi.nlm.nih.gov/28447912/) sau registrul european RET-MAP, din care [s-au publicat analize valoroase](https://pubmed.ncbi.nlm.nih.gov/36646211/) -- adună date de la zeci de spitale. Le suntem recunoscători celor care le-au construit: fără ele am ști mult mai puțin.
...
- **EGFR Resisters** -- o comunitate de pacienți cu cancer pulmonar EGFR+, pornită dintr-un grup de Facebook. Prin [Project PRIORITY](https://www.egfrcancer.org/project-priority/), pacienții și-au donat direct datele clinice și genomice, cu consimțământ, pentru cercetare -- inclusiv în parteneriat cu industria. Rezultatul: studii publicate, întrebări ale pacienților ajunse pe agenda cercetătorilor, și o comunitate care nu mai așteaptă să fie studiată -- se studiază. Iar rezultatele se întorc la comunitate: dashboard-ul public [EGFR Data Explorer](https://egfr.lungevity.org/project-priority-dashboard) arată oricui ce au învățat din datele donate.
- **ACCELERATE (boala Castleman)** și **FibroRegistry (cancer hepatic fibrolamelar)** -- două dintre cele mai puternice povești patient-driven din medicină: [ACCELERATE](https://cdcn.org/patients-loved-ones/join-the-registry/), registrul fondat de un pacient-medic, și-a atins ținta de înscrieri de 5 ani în doar 2 și a contribuit direct la găsirea unui tratament repoziționat; [FibroRegistry](https://fibroregistry.org/) a fost fondat de o pacientă care, ca adolescentă, a co-descoperit chiar mutația driver a propriei boli -- iar registrul condus de pacienți și familii a produs deja articole științifice publicate.
...
- **NORD IAMRARE** și **RARE-X** -- dovada că modelul are deja infrastructură matură: programul [IAMRARE](https://iamrare.org/) al organizației americane pentru boli rare (NORD) găzduiește peste 40 de registre conduse de organizații de pacienți, cu mii de participanți, iar [RARE-X](https://rare-x.org/) (Global Genes) a construit o platformă în care datele rămân ale pacientului, cu opțiuni de partajare alese individual -- exact modelul de consimțământ granular pe care îl propunem și noi.
