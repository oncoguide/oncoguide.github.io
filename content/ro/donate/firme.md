...
Există două variante, ambele bazate pe un contract de sponsorizare:

**Varianta A -- sponsorizare în cursul anului.** Firma plătește suma direct către asociație și o scade din impozitul pe profit datorat (credit fiscal), în limita plafonului legal.

**Varianta B -- redirecționare prin formularul 177.** După închiderea anului, firma cere ANAF să vireze o parte din impozitul deja datorat către asociație. Statul face plata, nu firma.
...
- **Contractul de sponsorizare** se poate semna oricând în cursul anului.
- **Formularul 177** se depune prin SPV-ul firmei până la termenul legal (de regulă 25 iunie pentru impozitul anului precedent).
- **Formularul 107** (declarația informativă privind sponsorizările) se depune odată cu declarația anuală de impozit pe profit.

Detaliile complete, cu surse oficiale: [Legea 32/1994 privind sponsorizarea](https://legislatie.just.ro/Public/DetaliiDocument/4399) și [formularul 177 pe anaf.ro](https://static.anaf.ro/static/10/Anaf/formulare/177_A2_OPANAF_3562_2024.pdf).

{{< callout type="tip" >}}
**Microîntreprinderile:** regulile s-au schimbat din 2024 (OUG 115/2023) și, în interpretarea curentă, microîntreprinderile nu mai beneficiază de creditul fiscal pentru sponsorizare. Dacă firma ta e microîntreprindere, întreabă contabilul înainte -- sau susține-ne printr-o [donație directă]({{< relref "/donate" >}}), disponibilă oricui.
{{< /callout >}}
