---
title: "Vaccinuri personalizate impotriva cancerului"
date: 2026-07-22
draft: false
description: "Tipurile de vaccinuri terapeutice, ce a mers si ce nu in studii, limitele reale, si centrele pe care le-am gasit -- cu criteriile prin care decid ce mi se potriveste mie."
tags: ["vaccin cancer", "imunoterapie", "medicina personalizata", "neoantigene", "celule dendritice", "mRNA", "peptide", "cancer pulmonar", "RET", "fuziune genetica"]
categories: ["Blog"]
...
Data trecută [scriam](/ro/blog/standard-of-care-vs-medicina-personalizata/) că investighez vaccinurile, dar că nu pornesc niciunul deocamdată. Poziția aceea s-a schimbat.

Motivul e simplu, și e legat de [rezultatul de la luna 6](/ro/blog/luna-6-rezultate-pet-ct/): am foarte puțină boală, tratamentul ține, și mă simt bine. Din punct de vedere imunologic, ăsta e cel mai bun moment posibil pentru un vaccin -- nu unul de amânat.
...
**1. De ce material are nevoie?** Țesut proaspăt congelat? Bloc de parafină arhival? Doar sânge? Doar o secvență pe hârtie?
**2. Ținta e a ta, sau e comună?** Un vaccin de raft și unul construit pe mutațiile tumorii tale sunt lucruri fundamental diferite, chiar dacă amândouă se numesc "vaccin".
{{< /callout >}}
...
În melanom, un vaccin mRNA personalizat combinat cu imunoterapie a redus semnificativ riscul de recidivă după operație, cu beneficiu menținut la câțiva ani ([KEYNOTE-942](https://pubmed.ncbi.nlm.nih.gov/38246194/)). E cel mai bun rezultat din toată clasa. Atenție însă la context: melanomul are foarte multe mutații, iar vaccinul a fost dat **împreună cu** imunoterapie. Două lucruri pe care eu nu le am.
...
Mai e un lucru pe care trebuie să-l spun despre studiul pe care se sprijină toată ideea. În 2025 a fost publicată o lucrare care arată că peptide construite pe această joncțiune pot fi recunoscute de sistemul imunitar ([Castillo și colab., 2025](https://pubmed.ncbi.nlm.nih.gov/41246330/)). E încurajator. Dar are patru limite pe care nu am voie să le ascund:
...
**Fuziunea ALK, la șoareci.** ALK e "vărul" apropiat al cazului meu: tot cancer pulmonar, tot condus de o fuziune. Un vaccin construit pe peptidul fuziunii, dat împreună cu pastila țintită, a eradicat tumorile și a prevenit metastazele cerebrale la șoareci ([Mota și colab., 2023](https://pubmed.ncbi.nlm.nih.gov/37430060/)). E doar un model animal -- dar e exact mecanismul pe care l-aș folosi. Ideea a ajuns și într-un studiu clinic uman, [ARCHER](https://clinicaltrials.gov/study/NCT05950139), deschis pacienților cu ALK. Nu și celor cu RET.

**O fuziune, la un om, în Germania.** Într-un cancer hepatic rar condus tot de o fuziune, a fost construit și administrat un vaccin peptidic pe joncțiune, fără imunoterapie, exact pe ruta legală descrisă mai sus ([publicat în 2022](https://pubmed.ncbi.nlm.nih.gov/36302754/)). Nu dovedește că funcționează la scară. Dovedește că **lucrul ăsta se poate construi și da unui om real** -- ceea ce, când începusem, nu știam.
...
Am scris despre ea și [data trecută](/ro/blog/standard-of-care-vs-medicina-personalizata/), dar aici e și mai la locul ei.
...
{{< callout type="tip" >}}
Sijbrandij Foundation -- FCCT, gratuit pentru pacienți: lista de furnizori și consultul de 30 de minute. [sijbrandijfoundation.org/fcct#suppliers](https://sijbrandijfoundation.org/fcct#suppliers)
{{< /callout >}}
...
Dacă ești medic, navigator oncologic sau pacient și ai experiență cu vreunul dintre centrele astea -- sau cu altele pe care nu le-am găsit -- [scrie-mi](/ro/contact/). Am ajuns aici întrebând oameni, și tot așa vreau să merg mai departe.

---

{{< action-box >}}
1. **Inventariază-ți țesutul.** Întreabă laboratorul care ți-a făcut testele câte secțiuni ți-au mai rămas și ce procent de tumoră are blocul acum. "Țesutul e bun" și "mai am destul" sunt lucruri diferite.
2. **Cere tipizarea HLA la patru cifre.** E ieftină, se face o dată, și decide dacă o țintă peptidică are sens pentru tine.
3. **Dacă tumora ta e condusă de o fuziune, cere raportul cu joncțiunea exactă** -- exonii implicați și coordonatele -- nu doar numele celor două gene. De obicei datele există deja, doar nu ajung în raportul clinic.
