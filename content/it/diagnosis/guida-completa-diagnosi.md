...
**NON accettare la biopsia senza PET-CT.** Devi conoscere l'estensione della malattia prima di decidere da dove e come fare la biopsia. In un centro specializzato, la PET-CT e il primo passo. Se il tuo medico propone la biopsia senza imaging completo, chiedi perche.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Insisti per avere abbastanza tessuto.** Dillo al medico che esegue la biopsia: avrai bisogno di test molecolari/genetici (NGS). Se viene prelevato troppo poco materiale, potresti dover ripetere la biopsia -- il che significa tempo perso e una procedura in piu.
{{< /callout >}}

{{< callout type="tip" >}}
Quando prenoti la biopsia, chiedi: "Verra prelevato abbastanza materiale per il test molecolare NGS?" Questo va pianificato dall'inizio, non scoperto in seguito.
{{< /callout >}}
...
{{< callout type="warning" >}}
**NON iniziare il trattamento senza i risultati dei test molecolari.** Un trattamento scelto senza queste informazioni puo essere inefficace o addirittura controproducente. Eccezione: situazioni di emergenza medica in cui il ritardo del trattamento mette in pericolo la vita.
{{< /callout >}}

{{< callout type="warning" >}}
**NON accettare 21+ giorni di attesa per i test molecolari** senza chiedere quali opzioni piu rapide esistano. I centri specializzati ottengono risultati in 3-10 giorni. Se il laboratorio locale non puo, chiedi dell'invio del campione a un laboratorio piu rapido o della biopsia liquida (dal sangue) come alternativa.
{{< /callout >}}
...
- **Whole Genome Sequencing (WGS):** Testa l'intero genoma, incluse le regioni non codificanti. L'opzione piu completa -- il 73-89% dei pazienti riceve risultati azionabili. Disponibile tramite programmi no-profit come [Hartwig Medical Foundation OncoAct](https://oncoact.nl/en/) (Paesi Bassi, NSCLC esplicitamente coperto), e programmi accademici come NCT MASTER (Heidelberg, Germania -- WGS + RNA-seq + analisi del metiloma gratuiti)
...
{{< callout type="warning" >}}
**NON accettare un piano terapeutico deciso da un solo medico.** Chiedi: "Il mio caso verra presentato al comitato oncologico? Quando? Posso sapere cosa e stato deciso?" Se non esiste un comitato oncologico, tienine conto quando scegli dove curarti.
{{< /callout >}}
...
- **[OncoKB](https://www.oncokb.org/)** (Memorial Sloan Kettering) -- 8.000+ alterazioni classificate per livello di azionabilita (approvato FDA, evidenza clinica, sperimentale). Gratuito per uso clinico
- **[CIViC](https://civicdb.org/)** (Washington University) -- database di evidenza clinica curato dalla comunita scientifica, che collega mutazioni a trattamenti. Accesso libero
- **[ClinicalTrials.gov](https://clinicaltrials.gov/)** -- cerca le tue mutazioni specifiche per trovare studi clinici aperti in tutto il mondo
...
{{< callout type="tip" >}}
**Il giorno in cui ricevi i risultati molecolari:** Inserisci ogni mutazione identificata in OncoKB. Se una mutazione mostra evidenza di "Livello 1" o "Livello 2" per un trattamento che non stai ricevendo, portalo alla prossima visita oncologica.
{{< /callout >}}
...
{{< callout type="tip" >}}
Prepara un fascicolo completo prima del second opinion: imaging su CD/DVD o link, referto istopatologico, risultati dei test molecolari, tutte le analisi del sangue. Piu il fascicolo e completo, piu il parere sara utile.
{{< /callout >}}
...
{{< callout type="tip" >}}
Questa non e pubblicita per un centro specifico. E un esempio di come dovrebbe funzionare qualsiasi centro oncologico serio. Usa questi parametri come standard quando valuti dove curarti.
{{< /callout >}}
...
1. **NON accettare la biopsia senza PET-CT** -- devi conoscere l'estensione della malattia prima
2. **NON iniziare il trattamento senza test molecolari** -- potresti perdere il trattamento piu adatto a te
3. **NON accettare un piano da un solo medico** -- chiedi il comitato oncologico
4. **NON accontentarti di tempi di attesa di 21+ giorni per i test** -- esistono opzioni piu rapide
5. **NON prendere decisioni importanti nelle prime 48 ore** -- le emozioni sono al massimo, le informazioni al minimo
6. **NON cercare su Google a caso** -- le informazioni non verificate aumentano il panico senza beneficio reale
7. **NON dare per scontato che il tuo medico faccia tutto automaticamente** -- sii il tuo advocate, chiedi, verifica, pretendi
...
{{< action-box >}}
1. **Chiedi una PET-CT whole-body** come primo passo, prima della biopsia
2. **Dillo al medico che esegue la biopsia** che hai bisogno di abbastanza materiale per i test molecolari NGS
3. **Chiedi esplicitamente dei test molecolari** -- cosa viene testato, quando arrivano i risultati, esiste un pannello rapido?
4. **Chiedi la presentazione al comitato oncologico** -- chiedi quando sara e cosa e stato deciso
5. **Prepara il fascicolo per il second opinion** -- imaging, anatomia patologica, test molecolari, analisi
{{< /action-box >}}
