---
title: "Conservare del tessuto tumorale: una guida per pazienti e familiari"
date: 2026-06-22
draft: false
description: "Come conservare il tessuto tumorale per futuri test molecolari, studi di risposta ai farmaci e terapie personalizzate. Cosa chiedere prima di una biopsia."
tags: ["conservazione tessuto", "biopsia", "tessuto fresco congelato", "test molecolari", "biobanca"]
...
Questa e una riproduzione OncoGuide di **"Preserving Your Tumor Tissue"** (Conservare il tuo tessuto tumorale), pubblicata da [Future of Cancer Care Today (FCCT)](https://sijbrandijfoundation.org/FCCT), un'iniziativa della Sijbrandij Foundation. La ripubblichiamo con attribuzione affinche i pazienti di ogni lingua possano utilizzarla. Il contenuto medico e invariato. Leggi il [PDF originale in inglese](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf).
{{< /callout >}}
...
- Le politiche di conservazione variano, sebbene le istituzioni conservino comunemente i blocchi secondo gli standard del [College of American Pathologists (CAP)](https://www.cap.org/) e altri standard normativi.
...
{{< callout type="important" >}}
**Tempistica critica.** La conservazione del tessuto fresco, il prelievo aggiuntivo e gli accordi di conservazione con terze parti devono essere tutti predisposti prima della procedura. Se hai in programma una biopsia o un intervento chirurgico, ora e il momento di chiedere.
{{< /callout >}}
...
1. Cosa accade al mio tessuto dopo questa procedura?
2. E possibile prelevare tessuto aggiuntivo oltre a quello necessario per la diagnosi?
3. E possibile conservare una porzione fresca o congelata, non solo fissata in sostanze chimiche?
4. Quanto tessuto e probabile che rimanga dopo la diagnosi, e per quanto tempo sara conservato?
5. Se voglio utilizzare un servizio di conservazione del tessuto, l'equipe puo coordinarsi con loro?
6. Data la mia diagnosi, per quali test questo tessuto potrebbe essere utile, ora o in futuro?
...
{{< callout type="tip" >}}
Tumori diversi richiedono test diversi. Per cio che conta di piu nella tua situazione specifica, consulta le nostre [guide principali per sottotipo molecolare](/it/cancer-types/).
{{< /callout >}}

---

{{< action-box >}}
1. **Se e programmata una biopsia o un intervento chirurgico, solleva ora la questione della conservazione del tessuto** -- prima della procedura, non dopo.
2. **Chiedi se e possibile prelevare tessuto extra** oltre a quanto serve per la diagnosi, e se una porzione puo essere conservata fresca o congelata.
3. **Chiedi dove sara conservato il tuo tessuto** e per quanto tempo.
4. **Se una procedura e gia avvenuta, chiedi quale tessuto esiste ancora** e se puo essere utilizzato o trasferito a un altro laboratorio.
5. **Leggi la [guida FCCT originale](https://static1.squarespace.com/static/6306491067d7c950dcc669fe/t/6a332e97f2d57e6ef8d94fd5/1781739159729/FCCT_Tissue_Preservation_Playbook.pdf)** e porta le domande qui sopra alla tua equipe di cura.
{{< /action-box >}}
