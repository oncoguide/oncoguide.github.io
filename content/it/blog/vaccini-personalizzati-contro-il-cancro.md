---
title: "Vaccini personalizzati contro il cancro"
date: 2026-07-22
draft: false
description: "I tipi di vaccino terapeutico, cosa ha funzionato e cosa no negli studi, i limiti reali e i centri che ho trovato -- e i criteri con cui decido cosa fa per me."
tags: ["vaccino antitumorale", "immunoterapia", "medicina personalizzata", "neoantigeni", "cellule dendritiche", "mRNA", "peptidi", "cancro al polmone", "RET", "fusione genica"]
categories: ["Blog"]
...
La volta scorsa [scrivevo](/it/blog/standard-of-care-e-medicina-personalizzata/) che stavo studiando i vaccini, ma che per ora non ne avviavo nessuno. Quella posizione è cambiata.

Il motivo è semplice, ed è legato al [risultato del sesto mese](/it/blog/pet-ct-al-sesto-mese/): ho pochissima malattia, il trattamento tiene e mi sento bene. Dal punto di vista immunologico, questo è il momento migliore possibile per un vaccino -- non uno da rimandare.
...
**1. Di che materiale ha bisogno?** Tessuto fresco congelato? Un blocchetto di paraffina d'archivio? Solo sangue? Solo una sequenza sulla carta?
**2. Il bersaglio è tuo, o è comune?** Un vaccino pronto all'uso e uno costruito sulle mutazioni del tuo tumore sono cose fondamentalmente diverse, anche se entrambe si chiamano "vaccino".
{{< /callout >}}
...
C'è un'altra cosa che devo dire sullo studio su cui si appoggia tutta l'idea. Nel 2025 è stato pubblicato un lavoro che mostra che peptidi costruiti su questa giunzione possono essere riconosciuti dal sistema immunitario ([Castillo et al., 2025](https://pubmed.ncbi.nlm.nih.gov/41246330/)). È incoraggiante. Ma ha quattro limiti che non ho il diritto di nascondere:
...
**La fusione ALK, nei topi.** ALK è il "cugino" stretto del mio caso: sempre cancro al polmone, sempre guidato da una fusione. Un vaccino costruito sul peptide della fusione, somministrato insieme alla pastiglia mirata, ha eradicato i tumori e prevenuto le metastasi cerebrali nei topi ([Mota et al., 2023](https://pubmed.ncbi.nlm.nih.gov/37430060/)). È solo un modello animale -- ma è esattamente il meccanismo che userei. L'idea è arrivata anche in uno studio clinico sull'uomo, [ARCHER](https://clinicaltrials.gov/study/NCT05950139), aperto ai pazienti con ALK. Non a quelli con RET.

**Una fusione, in una persona, in Germania.** In un raro tumore del fegato guidato anch'esso da una fusione, è stato costruito e somministrato un vaccino peptidico sulla giunzione, senza immunoterapia, esattamente sulla via legale descritta sopra ([pubblicato nel 2022](https://pubmed.ncbi.nlm.nih.gov/36302754/)). Non dimostra che funzioni su larga scala. Dimostra che **questa cosa si può costruire e dare a una persona reale** -- cosa che, quando avevo cominciato, non sapevo.
...
Ne ho scritto anche [la volta scorsa](/it/blog/standard-of-care-e-medicina-personalizzata/), ma qui è ancora più al suo posto.
...
{{< callout type="tip" >}}
Sijbrandij Foundation -- FCCT, gratuito per i pazienti: l'elenco dei fornitori e il consulto di 30 minuti. [sijbrandijfoundation.org/fcct#suppliers](https://sijbrandijfoundation.org/fcct#suppliers)
{{< /callout >}}
...
Se sei un medico, un navigatore oncologico o un paziente e hai esperienza con uno di questi centri -- o con altri che non ho trovato -- [scrivimi](/it/contact/). Sono arrivato qui facendo domande alle persone, ed è così che voglio andare avanti.

---

{{< action-box >}}
1. **Fai l'inventario del tuo tessuto.** Chiedi al laboratorio che ti ha fatto i test quante sezioni ti sono rimaste e che percentuale di tumore ha il blocchetto adesso. "Il tessuto è buono" e "ne ho ancora abbastanza" sono cose diverse.
2. **Chiedi la tipizzazione HLA a quattro cifre.** È economica, si fa una volta, e decide se un bersaglio peptidico ha senso per te.
3. **Se il tuo tumore è guidato da una fusione, chiedi il referto con la giunzione esatta** -- gli esoni coinvolti e le coordinate -- non solo il nome dei due geni. Di solito i dati esistono già, solo che non arrivano nel referto clinico.
