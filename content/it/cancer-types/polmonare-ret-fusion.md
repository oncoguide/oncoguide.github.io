...
**Il tuo cancro NON e' causato dal fumo.** E' un incidente genetico spontaneo nelle cellule tumorali, non nei tuoi geni ereditari. Se sei all'inizio del percorso, leggi anche la [guida completa alla diagnosi oncologica](/it/diagnosis/guida-completa-diagnosi/) -- trovi l'ordine corretto dei passi, dal PET-CT ai test molecolari.
...
**STAMPA QUESTA PAGINA. METTILA SUL FRIGORIFERO. PORTALA NEL PORTAFOGLIO. DANNE UNA COPIA AL PARTNER/ALLA FAMIGLIA.**

---

### CHECKLIST DI EMERGENZA -- Vai al pronto soccorso se hai uno qualsiasi di questi:
...
**Contesto:** Selpercatinib e' stato approvato inizialmente come trattamento di **seconda linea** (dopo il fallimento della chemioterapia). Nel 2022 (FDA) e 2023 (EMA), e' stato aggiornato a **trattamento di prima linea** sulla base dei risultati LIBRETTO-431. Sia [ESMO](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer) che [NCCN](https://www.nccn.org/professionals/physician_gls/pdf/nscl.pdf) raccomandano ora Selpercatinib come **monoterapia di prima linea Categoria 1**.
...
3. Il fascicolo del tribunale deve includere:
   ...
   - [Le linee guida cliniche ESMO per il NSCLC metastatico](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer)
   - [L'autorizzazione all'immissione in commercio EMA per Retevmo](https://www.ema.europa.eu/en/medicines/human/EPAR/retsevmo)
...
| Risorsa | Cosa offre |
|---|---|
| **[RETpositive.org](https://www.retpositive.org)** | Gruppi Facebook privati, monitoraggio studi clinici, registri di qualita' della vita, storie di pazienti |
| **[The Happy Lungs Project](https://www.happylungsproject.org)** | Aggiornamenti di ricerca specifici RET, storie, webinar |
| **[RET Renegades](https://www.facebook.com/groups/retrengades)** (Facebook) | Gruppo di supporto co-fondato da una sopravvissuta RET+ NSCLC di 18+ anni |
| **[LUNGevity Foundation](https://www.lungevity.org)** | Comunita' di supporto specifiche RET, il navigatore LungMATCH |
| **[Cancer GRACE](https://cancergrace.org)** | Forum per pazienti con fusione RET, discussioni sul trattamento |
...
- **[LUNGevity Caregiver Support Groups](https://www.lungevity.org/for-supporters-caregivers)** -- forum online per le famiglie
- **[CancerCare 15-Week Online Support Group](https://www.cancercare.org/support_groups)** -- gruppo gratuito di supporto per caregiver
- **[My Cancer Circle](https://www.mycancercircle.net)** -- strumento online gratuito per organizzare la rete di assistenza
- **ALA Survivor Network** -- rete di supporto per sopravvissuti al cancro polmonare e i loro caregiver

---

{{< action-box >}}
1. **Stampa la sezione "Quando andare al pronto soccorso"** e mettila sul frigorifero e nel portafoglio
2. **Stampa la lista delle interazioni farmacologiche** e mostrala a ogni medico e farmacista
3. **Chiedi all'oncologo** del partner di fusione RET, delle co-mutazioni e del programma di RM cerebrale -- vedi anche la [guida alla diagnosi](/it/diagnosis/guida-completa-diagnosi/) per l'ordine corretto delle indagini
4. **In Romania:** Contatta un avvocato per l'Ordonanta Presedintiala se hai bisogno di accesso in prima linea a Selpercatinib
