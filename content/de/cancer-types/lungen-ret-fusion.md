---
title: "Lungenkrebs mit RET-Fusion: Der vollstandige Patientenleitfaden"
date: 2026-03-19
draft: false
description: "Alles ueber RET-Fusions-Lungenkrebs: Behandlung mit Selpercatinib, Nebenwirkungen, Notfaelle, Resistenz, Zugang in Europa und taegliches Leben."
tags: ["Lungenkrebs", "RET-Fusion", "Selpercatinib", "Retevmo", "zielgerichtete Therapie", "Patientenleitfaden"]
...
**Wenn du nur FISH hattest, ohne NGS:** Fordere eine Bestaetigung durch NGS an. FISH kann falsch-positive Ergebnisse liefern und identifiziert nicht den genauen Fusionspartner. NGS erkennt auch Co-Mutationen, die die Prognose beeinflussen.
{{< /callout >}}
...
**Akzeptiere KEINE Immuntherapie allein fuer RET-fusionierten Lungenkrebs.** Der internationale Behandlungsstandard ist Selpercatinib, nicht Pembrolizumab oder Nivolumab.
{{< /callout >}}
...
{{< callout type="tip" >}}
**Ueberpruefen Sie jedes Lebensmittel oder Nahrungsergaenzungsmittel vor dem Verzehr.** Sie koennen ein KI-Tool (wie ChatGPT, Claude oder Gemini) verwenden, um schnell die Wechselwirkung zwischen Selpercatinib und jedem Inhaltsstoff zu ueberpruefen. Fragen Sie: "Interagiert [Lebensmittelname] mit Selpercatinib (RET-Inhibitor, CYP3A4/CYP2C8-Substrat)?" Dies ersetzt keine aerztliche Beratung, kann Ihnen aber helfen, potenzielle Risiken zu identifizieren, die Sie mit Ihrem Onkologie-Team besprechen sollten.
{{< /callout >}}
...
{{< callout type="warning" >}}
**Neue oder verschlimmerte Atemnot + trockener Husten + Fieber** -- Rufe 112 / Gehe SOFORT in die Notaufnahme. Diese Trias ist das Alarmsignal fuer medikamentoes bedingte Pneumonitis. **Nimm die naechste Dosis NICHT ein**, bis ein Arzt dich untersucht hat.
{{< /callout >}}

{{< callout type="warning" >}}
**Bluthusten ODER unerklarliche Blutung, die nicht aufhoert** -- Rufe SOFORT 112. Blutungsereignisse sind bei Selpercatinib dokumentiert, einschliesslich Hirn- und Atemwegsblutungen.
{{< /callout >}}

{{< callout type="warning" >}}
**Gelbfaerbung von Haut/Augen + dunkler Urin + Schmerzen im rechten Oberbauch** -- Gehe NOCH AM SELBEN TAG in die Notaufnahme. Klassische Zeichen schwerer Hepatotoxizitaet. **Setze Selpercatinib ab und gehe direkt in die Notaufnahme.**
{{< /callout >}}

{{< callout type="warning" >}}
**Brustschmerzen + Herzklopfen + Ohnmacht oder Beinahe-Ohnmacht** -- Rufe SOFORT 112. Selpercatinib verursacht QTc-Verlaengerung -- eine gefaehrliche Veraenderung des Herzrhythmus. Sage in der Notaufnahme, dass du Selpercatinib nimmst -- sie werden sofort ein EKG machen.
{{< /callout >}}

{{< callout type="warning" >}}
**Ploetzliche Schwaeche auf einer Koerperseite + starke Kopfschmerzen + Verwirrtheit** -- Rufe SOFORT 112. Zeichen einer Hirnblutung oder eines Schlaganfalls.
{{< /callout >}}

{{< callout type="warning" >}}
**Brustdruck + Atembeschwerden im Liegen** -- Gehe NOCH AM SELBEN TAG in die Notaufnahme. Verdacht auf Perikarderguss (Fluessigkeit um das Herz).
{{< /callout >}}

{{< callout type="warning" >}}
**Schwere Muedigkeit + Muskelkraempfe + dunkler Urin + Uebelkeit (besonders in den ersten Wochen)** -- Gehe in die Notaufnahme / Rufe die onkologische Bereitschaftsnummer SOFORT an. Verdacht auf Tumorlyse-Syndrom.
{{< /callout >}}

{{< callout type="warning" >}}
**Fieber ueber 38,5C + Schuettelfrost + schneller Herzschlag + ohne offensichtliche Ursache** -- Rufe die onkologische Bereitschaftsnummer SOFORT an. Wenn keine Antwort innerhalb von 15 Minuten -- gehe in die Notaufnahme. **Fieber bei einem Krebspatienten unter zielgerichteter Therapie ist ein medizinischer Notfall, bis das Gegenteil bewiesen ist.**
{{< /callout >}}
...
1. **Fluessigbiopsie (ctDNA)** -- Bluttest, der Resistenzmutationen **Monate bevor** Scans Tumorwachstum zeigen, erkennen kann
2. **Gewebebiopsie** -- wenn die Fluessigbiopsie negativ ist, aber die Progression eindeutig ist
3. **Vollstaendiges NGS** -- obligatorisch bei jeder erneuten Biopsie
...
**Kontext:** Selpercatinib wurde urspruenglich als **Zweitlinienbehandlung** zugelassen (nach Versagen der Chemotherapie). 2022 (FDA) und 2023 (EMA) wurde es auf der Grundlage der LIBRETTO-431-Ergebnisse zur **Erstlinienbehandlung** aktualisiert. Sowohl [ESMO](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer) als auch [NCCN](https://www.nccn.org/professionals/physician_gls/pdf/nscl.pdf) empfehlen jetzt Selpercatinib als **Erstlinien-Monotherapie Kategorie 1**.
...
{{< callout type="important" >}}
**Wenn du in einem EU-Land lebst, in dem der Zugang zu Selpercatinib als Erstlinientherapie eingeschraenkt ist**, erkundige dich bei einer Patientenorganisation nach den rechtlichen Moeglichkeiten in deinem Land. Die EU-Richtlinie zur grenzueberschreitenden Gesundheitsversorgung (2011/24/EU) kann dir unter Umstaenden den Zugang zu Behandlung in einem anderen EU-Land ermoeglichen.
{{< /callout >}}
...
|---|---|
| **[RETpositive.org](https://www.retpositive.org)** | Private Facebook-Gruppen, Verfolgung klinischer Studien, Lebensqualitaetsregister, Patientengeschichten |
| **[Happy Lungs Project](https://www.happylungsproject.org)** | RET-spezifische Forschungsupdates, Geschichten, Webinare |
| **[RET Renegades](https://www.facebook.com/groups/retrengades)** (Facebook) | Selbsthilfegruppe, mitgegruendet von einer RET+ NSCLC-Ueberlebenden seit 18+ Jahren |
| **[LUNGevity Foundation](https://www.lungevity.org)** | RET-spezifische Selbsthilfegruppen, LungMATCH-Navigator |
| **[Cancer GRACE](https://cancergrace.org)** | Forum fuer RET-Fusionspatienten, Behandlungsdiskussionen |
| **[Inspire](https://www.inspire.com)** | Online-Gemeinschaft fuer Lungenkrebspatienten, Erfahrungsaustausch, Diskussionsforen |
| **[HealthUnlocked](https://healthunlocked.com)** | Patientenforen, Selbsthilfegruppen fuer seltene Krebsarten, Wissensaustausch |
...
- **[LUNGevity Caregiver Support](https://www.lungevity.org/for-supporters-caregivers)** -- Online-Foren und Ressourcen fuer Familien und pflegende Angehoerige
- **[CancerCare Support Groups](https://www.cancercare.org/support_groups)** -- kostenlose Selbsthilfegruppe fuer pflegende Angehoerige (15-Wochen-Programm und mehr)
- **[My Cancer Circle](https://www.mycancercircle.net)** -- kostenloses Online-Tool zur Organisation des Pflegenetzwerks
- **ALA Survivor Network** -- Netzwerk der American Lung Association fuer Ueberlebende und deren Angehoerige

{{< action-box >}}
1. **Drucke den Abschnitt "Wann du in die Notaufnahme musst" aus** und haenge ihn an den Kuehlschrank und trage ihn im Portemonnaie
2. **Drucke die Liste der Medikamentenwechselwirkungen aus** und zeige sie jedem Arzt und Apotheker
3. **Frage deinen Onkologen** nach dem RET-Fusionspartner, Co-Mutationen und dem Hirn-MRT-Zeitplan -- siehe auch den [Diagnose-Leitfaden](/de/diagnosis/vollstaendiger-diagnose-leitfaden/) fuer die richtige Reihenfolge der Untersuchungen
4. **In Deutschland:** Dein Onkologe kann Selpercatinib direkt als Erstlinientherapie verschreiben -- es wird von der GKV erstattet
