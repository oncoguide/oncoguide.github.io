---
title: "Unsere Daten, gemeinsam: Warum wir ein von Patienten aufgebautes RET-Register wollen"
date: 2026-09-01
draft: false
aliases: ["/blog/ret-patientenregister/"]
description: "Die medizinischen Daten von RET+ Patienten liegen fragmentiert in institutionellen Registern, zu denen Patienten keinen Zugang haben. Andere Krebs-Communities haben eigene Register aufgebaut und die Forschung verändert. Wir schlagen dasselbe vor -- und bitten um Ihre Meinung."
tags: ["Patientenregister", "RET", "medizinische Daten", "Datenzugang", "Advocacy", "Community", "Lungenkrebs", "EHDS", "patient-led research"]
categories: ["Blog"]
...
- **NORD IAMRARE** und **RARE-X** -- der Beleg, dass dieses Modell bereits über eine ausgereifte Infrastruktur verfügt: Das [IAMRARE](https://iamrare.org/)-Programm der US-Organisation für seltene Erkrankungen (NORD) beherbergt über 40 von Patientenorganisationen geführte Register mit Tausenden Teilnehmern, und [RARE-X](https://rare-x.org/) (Global Genes) hat eine Plattform aufgebaut, auf der die Daten Eigentum der Patienten bleiben, mit individuell wählbaren Freigabeoptionen -- genau das Modell der granularen Einwilligung, das wir vorschlagen.
...
4. **Daten gehostet in der EU**, unter der DSGVO, mit buchstabengetreuer Achtung der Patientenrechte. Die DSGVO ist hier nicht das Hindernis -- die ausdrückliche Einwilligung des Patienten ist genau der Mechanismus, den die DSGVO dafür vorsieht.
