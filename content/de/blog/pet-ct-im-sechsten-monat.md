---
title: "PET-CT im sechsten Monat"
date: 2026-07-22
draft: false
description: "Kontrolle nach sechs Monaten: Tumor stabil, Lymphknoten noch leicht aktiv, ein metabolischer Anstieg unter der Schwelle und die Entscheidung für SBRT."
tags: ["PET-CT", "Verlaufskontrolle", "SBRT", "stereotaktische Strahlentherapie", "Lungenkrebs", "RET", "Stadium IV", "SUV", "PERCIST", "CyberKnife", "MR-Linac"]
categories: ["Blog"]
...
Ich nehme seit Februar eine zielgerichtete Tablette gegen die RET-Fusion in meinem Tumor. ([Die Geschichte von Anfang an steht hier](/de/blog/meine-geschichte/), und darüber, wie ich über die Strategie denke, habe ich [hier](/de/blog/standard-of-care-und-personalisierte-medizin/) geschrieben.)
...
3. Eine zusätzliche [EARL](https://earl.eanm.org/)-standardisierte Rekonstruktion -- bei der Terminvereinbarung angefordert, weil sie sich nicht nachträglich erstellen lässt, sobald die Rohdaten gelöscht sind.
...
{{< action-box >}}
1. Fordere, dass alle Kontrolluntersuchungen auf **demselben Gerät, im selben Zentrum** gemacht werden -- das ist die Mindestbedingung, nicht die Garantie.
2. Fordere **schriftlich, bei der Terminvereinbarung**, dieselben Aufnahmeparameter wie bei der vorherigen Untersuchung an: Wartezeit nach der Injektion, angewandte Korrekturen, Rekonstruktionsversion, Kontrastmittelprotokoll.
3. Fordere eine **EARL-standardisierte Rekonstruktion** als zusätzliche Serie an. Sie lässt sich nicht nachträglich erstellen.
4. Wenn ein Wert im Befund fehlt, **fordere eine Ergänzung an**. Es ist kostenlos, dauert nicht lange und rettet dir deine Verlaufskurve in zwei Jahren.
5. Interpretiere keinen einzelnen SUV-Wert isoliert. Frag nach den PERCIST-Schwellen, nach der normalen Schwankung für eine Läsion deiner Größe und danach, was die CT-Komponente sagt.
6. Wenn dir eine stereotaktische Strahlentherapie vorgeschlagen wird, frag **warum dieses Gerät für deine Läsion** -- und fordere schriftlich die Dosis, die Anzahl der Sitzungen und die Regel für die zielgerichtete Tablette an.
{{< /action-box >}}
