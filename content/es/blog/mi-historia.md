---
title: "Mi historia: de un dolor de espalda a un diagnóstico completo de cáncer en diez días"
date: 2026-06-22
draft: false
description: "La historia real de un paciente de 42 años, no fumador, diagnosticado de cáncer de pulmón RET-positivo en estadio IV. Cómo pasé de un dolor de espalda a un diagnóstico completo en diez días."
tags: ["cáncer de pulmón", "RET", "diagnóstico", "historia de paciente", "estadio IV", "biopsia", "pruebas moleculares"]
categories: ["Blog"]
...
{{< action-box >}}
1. Pide cuanto antes la prueba molecular completa (NGS). Para muchos tipos de cáncer, la mutación encontrada cambia por completo el tratamiento.
2. Pregunta por un PET-CT antes de la biopsia, para que la muestra se tome de un sitio que esté sin duda activo.
3. Pregunta si se puede conservar tejido congelado ("fresh-frozen") de la biopsia -- puede abrir la puerta a tratamientos futuros.
4. Pide una segunda opinión, idealmente en un centro especializado solo en oncología, con tumor board.
5. Comprueba tus derechos de reembolso y no aceptes un rechazo burocrático como respuesta final.
{{< /action-box >}}
