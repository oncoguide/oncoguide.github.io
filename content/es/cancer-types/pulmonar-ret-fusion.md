---
title: "Cancer de pulmon con fusion RET: la guia completa para pacientes"
date: 2026-03-19
draft: false
description: "Todo lo que necesitas saber sobre el cancer de pulmon RET fusion-positivo: tratamiento con Selpercatinib, efectos secundarios, urgencias, resistencia y acceso."
tags: ["cancer de pulmon", "fusion RET", "selpercatinib", "Retevmo", "terapia dirigida", "guia paciente"]
...
| **Creatinina elevada** | ~18% | Generalmente NO significa dano renal real -- el medicamento eleva artificialmente la lectura |
...
Tres efectos secundarios **que antes no figuraban en el prospecto**, hallados en farmacovigilancia:

- **Disfagia** -- dificultad para tragar
- **Derrame pericardico** -- liquido alrededor del corazon (presion toracica, disnea en posicion tumbada)
- **Hemiparesia** -- debilidad en un lado del cuerpo (similar a un ictus)
...
| **LOXO-260** | Actua sobre mutaciones solvent front y gatekeeper | Fase 1; **acceso expandido disponible ahora** |
...
| **Activacion EGFR/HER3** | Selpercatinib + afatinib -- muerte celular restaurada en celulas resistentes |
...
**Contexto:** Selpercatinib fue aprobado inicialmente como tratamiento de **segunda linea** (tras el fracaso de la quimioterapia). En 2022 (FDA) y 2023 (EMA), fue actualizado a **tratamiento de primera linea** basandose en los resultados de LIBRETTO-431. Tanto [ESMO](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer) como [NCCN](https://www.nccn.org/professionals/physician_gls/pdf/nscl.pdf) recomiendan ahora Selpercatinib como **monoterapia de primera linea Categoria 1**.
...
3. El expediente judicial debe incluir:
   ...
   - [Las guias clinicas ESMO para CPNM metastasico](https://www.esmo.org/guidelines/lung-and-chest-tumours/metastatic-non-small-cell-lung-cancer)
   - [La autorizacion de comercializacion EMA para Retevmo](https://www.ema.europa.eu/en/medicines/human/EPAR/retsevmo)
...
| Recurso | Que ofrece |
|---|---|
| **[RETpositive.org](https://www.retpositive.org)** | Grupos privados de Facebook, seguimiento de ensayos clinicos, registros de calidad de vida, historias de pacientes |
| **[Happy Lungs](https://www.happylungsproject.org)** | Actualizaciones de investigacion especificas RET, historias, webinarios |
| **[RET Renegades](https://www.facebook.com/groups/retrengades)** (Facebook) | Grupo de apoyo cofundado por una superviviente RET+ CPNM de 18+ anos |
| **[LUNGevity](https://www.lungevity.org)** | Comunidades de apoyo especificas RET, navegador LungMATCH |
| **[Cancer GRACE](https://cancergrace.org)** | Foro para pacientes con fusion RET, discusiones de tratamiento |
| **[Inspire](https://www.inspire.com)** | Comunidad en linea de pacientes con cancer de pulmon, foros de apoyo |
| **[HealthUnlocked](https://healthunlocked.com)** | Red social de salud con comunidades especificas de cancer de pulmon |
...
- **[LUNGevity para cuidadores](https://www.lungevity.org/for-supporters-caregivers)** -- foros en linea y recursos para familias
- **[CancerCare](https://www.cancercare.org/support_groups)** -- grupos gratuitos de apoyo para cuidadores (15 semanas, en linea)
- **[My Cancer Circle](https://www.mycancercircle.net)** -- herramienta en linea gratuita para organizar la red de cuidado
- **[ALA Survivor Network](https://www.lung.org/support-and-community)** -- red de supervivientes y cuidadores de la American Lung Association

{{< action-box >}}
1. **Imprime la seccion "Cuando ir a urgencias"** y ponla en la nevera y en la cartera
2. **Imprime la lista de interacciones medicamentosas** y muestrasela a cada medico y farmaceutico
3. **Pregunta a tu oncologo** sobre el socio de fusion RET, co-mutaciones y el calendario de RM cerebral -- ver tambien la [guia de diagnostico](/es/diagnosis/guia-completa-diagnostico/) para el orden correcto de las investigaciones
4. **En Rumania:** Contacta a un abogado para la Ordonanta Presedintiala si necesitas acceso de primera linea a Selpercatinib
5. **Inscribete** en RETpositive.org y The Happy Lungs Project -- encuentra tu comunidad
6. **Habla con tu oncologo** sobre el plan de accion si aparece resistencia -- antes de necesitarlo
7. **Pide la biopsia liquida (ctDNA)** para monitorizacion -- puede detectar resistencia meses antes de que las exploraciones lo muestren
{{< /action-box >}}
